...
export namespace dex {
  ...
  export function addDexPool(
    ...
    dexPool.totalValueLockedUSD = BIGDECIMAL_ZERO;
  ...
  function _addLiquidity(
    ...
    aggregateEntity.tokenCount =
      aggregateEntity.tokenCount.plus(totalTokensAdded);
    ...
    if (!isAccountAlreadyAdded) {
      ...
      aggregatedAccount.index = currentCount;
    }
