...
export namespace nft {
  export function trackNFTSaleTransactions(
    ...
    let volumeInUSD = BIGDECIMAL_ZERO; // getUsdPrice(paymentTokenAddress, formattedAmount);
    ...
    for (let i = 0; i < transactionCount; i++) {
      ...
      sellActionDailyAggregatedEntity.transactionCount =
        sellActionDailyAggregatedEntity.transactionCount.plus(BIGINT.ONE);
      sellActionDailyAggregatedEntity.volumeInUSD =
        sellActionDailyAggregatedEntity.volumeInUSD.plus(volumeInUSD);
      ...
      buyActionDailyAggregatedEntity.transactionCount =
        buyActionDailyAggregatedEntity.transactionCount.plus(BIGINT.ONE);
      buyActionDailyAggregatedEntity.volumeInUSD =
        buyActionDailyAggregatedEntity.volumeInUSD.plus(volumeInUSD);
      ...
      let sellAggregatedEntityAccount =
        getOrCreateAirDailyAggregateEntityAccount(
      ...
      sellAggregatedEntityAccount.volumeInUSD =
        sellAggregatedEntityAccount.volumeInUSD.plus(nftVolumeInUSD);
      sellAggregatedEntityAccount.index =
        sellActionDailyAggregatedEntity.walletCount.plus(BigInt.fromI32(1));

      let buyAggregatedEntityAccountId = getDailyAggregatedAccountId(
        buyActionDailyAggregatedEntityId,
        buyerAccount.id
      );
      let buyAggregatedEntityAccount =
        getOrCreateAirDailyAggregateEntityAccount(
          buyAggregatedEntityAccountId,
          buyerAccount.id
        );
      buyAggregatedEntityAccount.volumeInUSD =
        buyAggregatedEntityAccount.volumeInUSD.plus(nftVolumeInUSD);
      buyAggregatedEntityAccount.index =
        buyActionDailyAggregatedEntity.walletCount.plus(BigInt.fromI32(1));
      ...
      buyActionDailyAggregatedEntity.walletCount =
        buyActionDailyAggregatedEntity.walletCount.plus(
          BigInt.fromI32(newBuyWalletCount)
        );
      sellActionDailyAggregatedEntity.walletCount =
        sellActionDailyAggregatedEntity.walletCount.plus(
      ...
      let sellDailyAggregateEntityStats =
        getOrCreateAirDailyAggregateEntityStats(
      ...
      let buyDailyAggregateEntityStats =
        getOrCreateAirDailyAggregateEntityStats(buyDailyAggregateEntityStatsId);
      ...
      sellAggregatedEntityAccount.dailyAggregatedEntity =
        sellActionDailyAggregatedEntityId;
      buyAggregatedEntityAccount.dailyAggregatedEntity =
        buyActionDailyAggregatedEntityId;
